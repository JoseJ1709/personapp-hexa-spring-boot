...
public class EstudiosInputAdapterRest {
    ...
    private String setStudyOutputPortInjection(String dbOption) throws InvalidOptionException {
        if (dbOption.equalsIgnoreCase(DatabaseOption.MARIA.toString())) {
            studyInputPort = new StudyUseCase();
            studyInputPort.setPersistence(studyOutputPortMaria);
            return DatabaseOption.MARIA.toString();
        } else if (dbOption.equalsIgnoreCase(DatabaseOption.MONGO.toString())) {
            studyInputPort = new StudyUseCase();
            studyInputPort.setPersistence(studyOutputPortMongo);
    ...
    public Boolean eliminarEstudio(Integer personId, Integer professionId, String database) {
        try {
