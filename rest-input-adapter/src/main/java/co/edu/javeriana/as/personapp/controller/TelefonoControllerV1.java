...
public class TelefonoControllerV1 {
    ...
    public TelefonoResponse actualizarTelefono(@PathVariable String numero, @RequestBody TelefonoRequest request) {
        log.info("Into actualizarTelefono REST API");
        return telefonoInputAdapterRest.actualizarTelefono(numero, request);
    }
